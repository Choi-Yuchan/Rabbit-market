  ...
  return (
    <Layout canGoBack>
      <div className="px-4 py-10 space-y-5 ">
        ...
        <button className="w-full bg-orange-500 text-gray-50 hover:bg-orange-600 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
          Upload item
        </button>
      </div>
    </Layout>
